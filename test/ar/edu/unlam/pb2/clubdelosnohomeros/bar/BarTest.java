...
public class BarTest {
	...
	public void admitirClientes() throws BarCerradoException {
		...
		bar.ingresoCliente(new Cliente("Alan", 26));
		bar.ingresoCliente(new Cliente("Julia", 28));
	...
	public void noAdmitirClientesConMismoNombre() throws BarCerradoException {
		...
		bar.ingresoCliente(new Cliente("Luis", 26));
		bar.ingresoCliente(new Cliente("Luis", 21));
		bar.ingresoCliente(new Cliente("Marta", 28));
		bar.ingresoCliente(new Cliente("Pablo", 24));
		
		int clientesEsperados = 3;
